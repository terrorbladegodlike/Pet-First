    ...
    <section className='bg-adoption bg-cover bg-center bg-no-repeat min-h-[760px] py-8 flex'>
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-center gap-x-16">
        ...
        <div className='flex-1 mb-6 lg:mb-0'>
          <Image src={Img1} width={542} height={560} alt='img' />
        </div>
        {/* Text */}
        <div className='flex-1 text-cream text-center max-w-md lg:text-left lg:max-w-none'>
          ...
          <p className='mb-6'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis explicabo est accusamus dolorem aperiam deserunt eos fuga nobis! Iste culpa ea labore laboriosam odio porro eligendi facilis soluta, vel unde!
          </p>
          ...
          <button className='btn btn-primary mx-auto lg:mx-0'>Exlpore</button>
        </div>
      </div>
    </section>
  )
